...
ini_set("display_errors", 0); // should disable this on the live site eventually
...
// I wanna know if the user accessing the script is a guide or not.
// TODO: verify this with session id
$isGuide = false;
