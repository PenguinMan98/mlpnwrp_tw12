...
try{
	...
	if($editing){
		...
		if(!$userProvider->verifyUserAndCharacterId($userId, $character->getCharacterId())){
			throw new Exception("This is not your character.");
		}
	...
	header('Location: ' . SITE_ROOT . '/chat/character/create.php');
	die();
}
