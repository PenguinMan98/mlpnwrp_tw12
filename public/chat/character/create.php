    ...
    <div id="siteContainer">
      <div id="site">
        ...
        <div id="contentContainer">
        	...
        	<?php if( !empty($_SESSION['system_messages']) ): 
			...
			<div id="tabs">
				...
				<form id="characterForm" enctype='multipart/form-data' method="POST" action="<?php echo SITE_ROOT?>/chat/character/save.php">
					<div id="basics">
						<label>Character Name: (A-Z, 0-9, -, and _ only)</label>
						...
						<select name="race">
							...
							<option title="<?php echo $race->getDescription()?>" value="<?php echo $race->getCharacterRaceId()?>"><?php echo $race->getName()?></option>
							<?php endforeach; ?>
						</select><br>
						...
						<select name="age" id="age">
							...
							<option title="<?php echo $age->getDescription()?>" value="<?php echo $age->getCharacterAgeId()?>"><?php echo $age->getName()?></option>
							<?php endforeach; ?>
						</select><br><br>
